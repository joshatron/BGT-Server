...
public class AccountTest extends BaseTest {
    ...
    public void registerUser_OneUser_204UserCreated() throws Exception {
        String test = getTest();
        AccountUtils.addUser(test, "01", "password", client, HttpStatus.SC_OK);
    }
    ...
    public void registerUser_MultipleUsers_204UsersCreated() throws Exception {
        String test = getTest();
        AccountUtils.addUser(test, "01", "password", client, HttpStatus.SC_OK);
        AccountUtils.addUser(test, "02", "password", client, HttpStatus.SC_OK);
        AccountUtils.addUser(test, "03", "drowssap", client, HttpStatus.SC_OK);
    }
    ...
    public void registerUser_TryToRegisterWithDifferentCase_403OnlyOneUserCreated() throws Exception {
        String test = getTest();
        AccountUtils.addUser(test, "aa", "password", client, HttpStatus.SC_OK);
    ...
    public void registerUser_ColonInPassword_204UsersCreated() throws Exception {
        String test = getTest();
        AccountUtils.addUser(test, "01", ":password", client, HttpStatus.SC_OK);
        AccountUtils.addUser(test, "02", "pass:word", client, HttpStatus.SC_OK);
        AccountUtils.addUser(test, "03", "password:", client, HttpStatus.SC_OK);
    }
    ...
    public void changeUsername_OneUser_204UsernameChanged() throws Exception {
        String test = getTest();
        User user = AccountUtils.addUser(test, "01", "password", client, HttpStatus.SC_OK);
    ...
    public void changeUsername_MultipleUsers_204UsernamesChanged() throws Exception {
        String test = getTest();
        User user1 = AccountUtils.addUser(test, "01", "password", client, HttpStatus.SC_OK);
        User user2 = AccountUtils.addUser(test, "02", "12345678", client, HttpStatus.SC_OK);
